    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        p3 = rg.Point(intersection_center.x - (letter_thickness / 2), p1.y)
        p4 = rg.Point(intersection_center.x + (letter_thickness / 2), p1.y + height)
    ...
    def clone(self):
        ...
        other = CapitalT(rg.Point(0,0),0,0,0)
        other.h_rect = self.h_rect.clone()
        other.v_rect = self.v_rect.clone()
        other.set_colors(self.fill_color, self.outline_color)
        return other
